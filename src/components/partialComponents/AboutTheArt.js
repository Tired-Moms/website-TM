...
export default function AboutTheArt() {
	return (
		<div className="aboutTheArt">
			<h2>
			...
			<p>
				...
				cleaning, in short, giving everything for that little human being.{' '}
			</p>
			<p>
				<strong>
			...
			<hr className="lineHr" />
			<p>
				My name is Giselle Escandón, from Colombia. I am an illustrator,
				cartoonist, industrial designer, mom and wife. I love coffee in the
				mornings and if fatigue doesn't win me over, in the evenings I love
				watching movies with my husband.
			</p>
			<p>
				Since I was a child, I have always loved drawing, crafts and
